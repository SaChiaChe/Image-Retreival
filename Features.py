...
def GlobalColorHistogram(Image, channels=[0, 1, 2], n_bins=[8, 8, 8], ranges=[0, 256, 0, 256, 0, 256]):
	'''
...
def LocalColorHistogram(Image, n_rows=8, n_cols=8, channels=[0, 1, 2], n_bins=[8, 8, 8], ranges=[0, 256, 0, 256, 0, 256]):
	'''
...
def AutoCorrelogram(Image, channels=[0, 1, 2], n_bins=[4, 4, 4], ranges=[0, 256, 0, 256, 0, 256], Distances=[1, 2, 4, 8, 16, 32, 64]):
	'''
...
def GaborLocalHistogram(GaborImages, n_rows=8, n_cols=8, channels=[0], n_bins=[32], ranges=[0, 256]):
	'''
